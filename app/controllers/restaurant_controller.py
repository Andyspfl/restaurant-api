...
from app.models.restaurant_model import Restaurant  # Asegúrate de que el modelo esté correctamente importado
from app.utils.decorators import jwt_required, roles_required
from app.views.restaurant_view import render_restaurant_detail, render_restaurant_list  # Asegúrate de que estas funciones de vista existan y estén correctamente importadas
...
def create_restaurant():
    ...
    if not name or not address or not city or not phone or rating is None:
